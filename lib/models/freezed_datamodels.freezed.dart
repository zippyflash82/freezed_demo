...
class _$GeoImpl implements _Geo {
  const _$GeoImpl({this.lat = 0.0, this.lng = 0.0});
...
abstract class _Geo implements Geo {
  const factory _Geo({final double lat, final double lng}) = _$GeoImpl;
...
mixin _$Address {
  ...
  @JsonKey(fromJson: Address._geoFromJson, toJson: Address._geoToJson)
